...
bool cuda_stopPri(float *X, float *sol, int m, int n, float absTol, float relTol, int display);

/*compute the dual error and resudual*/
bool cuda_stopDual(float *sol, float *sol_o, float *U1, float *U2, float *U3, int m, int n, 
				float rho, float absTol, float relTol, int display);


/*get the function value*/
__inline float cuda_get_funval(const float *sol, const float *Y, const float lam, const int imgHeight, const int imgWidth);

/*method for isotropic TV*/
int cuda_tvl2_iso(float* sol, float* Y, const int imgHeight, const int imgWidth, const float lam, const float rho, const int maxIter, const float absTol, const float relTol, const int display);
...
bool cuda_stopPri(float *d_X, float *d_sol, int m, int n, float absTol, float relTol, int display)
{
...
float cuda_get_funval(const float *sol, const float *Y, const float lam, const int imgHeight, const int imgWidth){
